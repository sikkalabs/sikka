...
func (n *Node) routes() http.Handler {
	...
	mux.HandleFunc("GET /v1/dag/tips", n.handleDAGTips)
	mux.HandleFunc("GET /v1/peers", n.handlePeers)
	mux.HandleFunc("/v1/address/{address}", n.handleAddress)
	mux.HandleFunc("GET /v1/address/{address}/history", n.handleAddressHistory)
